        ...
        <div className="px-6 mb-8">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
              <div className="relative w-5 h-5 rounded-full border-2 border-white/90">
                <span className="absolute top-1/2 left-1/2 w-1.5 h-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white" />
                <span className="absolute top-[2px] left-1/2 w-[2px] h-[2px] -translate-x-1/2 rounded-full bg-white/90" />
                <span className="absolute bottom-[2px] left-1/2 w-[2px] h-[2px] -translate-x-1/2 rounded-full bg-white/90" />
                <span className="absolute top-1/2 left-[2px] w-[2px] h-[2px] -translate-y-1/2 rounded-full bg-white/90" />
                <span className="absolute top-1/2 right-[2px] w-[2px] h-[2px] -translate-y-1/2 rounded-full bg-white/90" />
              </div>
            </div>
            <div>
